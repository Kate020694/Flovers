            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        final selectedMedia =
                          ...
                          context: context,
                          storageFolderPath: random_data.randomString(
                            12,
                            12,
                            true,
                            false,
                  ...
                  Builder(
                    builder: (context) {
                      final imgs = _model.imgList.toList().take(4).toList();
                          ...
                          return Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onLongPress: () async {
                                  _model.removeFromImgList(imgsItem);
                                  safeSetState(() {});
                                },
                                child: Container(
                                  width: 54.0,
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          _model.addToImgList(_model.uploadedFileUrl2);
                          safeSetState(() {});
                        },
                        child: Container(
                          width: 54.0,
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await ProductTable().insert({
                          ...
                          'desk': _model.textController2.text,
                          'compound': _model.textController3.text,
                          'price': int.tryParse(_model.textController4.text),
                          'best': _model.switchValue,
                          'imgList': _model.imgList,
                        });
