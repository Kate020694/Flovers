...
class FlowersSupabaseUser extends BaseAuthUser {
  FlowersSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> flowersSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = FlowersSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
